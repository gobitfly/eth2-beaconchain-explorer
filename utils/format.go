...
func FormatBalance(balanceInt uint64, currency string) template.HTML {
	...
	balance := FormatFloatWithRightTrim((float64(balanceInt)/float64(1e9))*float64(exchangeRate), 2)
...
func FormatBalanceSql(balanceInt sql.NullInt64, currency string) template.HTML {
	...
	exchangeRate := ExchangeRateForCurrency(currency)
	balance := FormatFloatWithRightTrim((float64(balanceInt.Int64)/float64(1e9))*float64(exchangeRate), 2)
...
func FormatBalanceChange(balance *int64, currency string) template.HTML {
	...
	if currency == "ETH" {
		...
		exchangeRate := ExchangeRateForCurrency(currency)
		balanceFormated := FormatFloatWithRightTrim((float64(balanceF)/float64(1e9))*float64(exchangeRate), 2)
...
func FormatIncome(balanceInt int64, currency string) template.HTML {
	...
	balanceFormated := FormatFloatWithRightTrim(balance, decimals)
...
func FormatFloatWithRightTrim(num float64, precision int) string {
	s := FormatFloatWithPrecision(precision, num)
