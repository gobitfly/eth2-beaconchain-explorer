...
const file_eth1_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"eth1.proto\x12\x05types\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbc\x05\n" +
	"\tEth1Block\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\x12\x1f\n" +
	"\vparent_hash\x18\x02 \x01(\fR\n" +
	"parentHash\x12\x1d\n" +
	"\n" +
	"uncle_hash\x18\x03 \x01(\fR\tuncleHash\x12\x1a\n" +
	"\bcoinbase\x18\x04 \x01(\fR\bcoinbase\x12\x12\n" +
	"\x04root\x18\x05 \x01(\fR\x04root\x12\x17\n" +
	"\atx_hash\x18\x06 \x01(\fR\x06txHash\x12!\n" +
	"\freceipt_hash\x18\a \x01(\fR\vreceiptHash\x12\x1e\n" +
	"\n" +
	...
	"\x05extra\x18\r \x01(\fR\x05extra\x12\x1d\n" +
	"\n" +
	"mix_digest\x18\x0e \x01(\fR\tmixDigest\x12\x14\n" +
	"\x05bloom\x18\x11 \x01(\fR\x05bloom\x12\x19\n" +
	"\bbase_fee\x18\x12 \x01(\fR\abaseFee\x12(\n" +
	"\x06uncles\x18\x14 \x03(\v2\x10.types.Eth1BlockR\x06uncles\x12:\n" +
	"\ftransactions\x18\x15 \x03(\v2\x16.types.Eth1TransactionR\ftransactions\x127\n" +
	"\vwithdrawals\x18\x16 \x03(\v2\x15.types.Eth1WithdrawalR\vwithdrawals\x12\"\n" +
	"\rblob_gas_used\x18\x17 \x01(\x04R\vblobGasUsed\x12&\n" +
	"\x0fexcess_blob_gas\x18\x18 \x01(\x04R\rexcessBlobGas\"\x81\x01\n" +
	"\x0eEth1Withdrawal\x12\x14\n" +
	...
	"\x06amount\x18\x04 \x01(\fR\x06amount\"\xb3\x06\n" +
	"\x0fEth1Transaction\x12\x12\n" +
	"\x04type\x18\x01 \x01(\rR\x04type\x12\x14\n" +
	"\x05nonce\x18\x02 \x01(\x04R\x05nonce\x12\x1b\n" +
	"\tgas_price\x18\x03 \x01(\fR\bgasPrice\x126\n" +
	...
	"\x04logs\x18\x17 \x03(\v2\x0e.types.Eth1LogR\x04logs\x120\n" +
	"\x03itx\x18\x18 \x03(\v2\x1e.types.Eth1InternalTransactionR\x03itx\x12.\n" +
	"\x14max_fee_per_blob_gas\x18\x19 \x01(\fR\x10maxFeePerBlobGas\x122\n" +
	"\x15blob_versioned_hashes\x18\x1a \x03(\fR\x13blobVersionedHashes\x12$\n" +
	"\x0eblob_gas_price\x18\x1b \x01(\fR\fblobGasPrice\x12\"\n" +
	"\rblob_gas_used\x18\x1c \x01(\x04R\vblobGasUsedJ\x04\b\x16\x10\x17\"M\n" +
	...
	"\fstorage_keys\x18\x02 \x03(\fR\vstorageKeys\"i\n" +
	"\aEth1Log\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\fR\aaddress\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x12\x18\n" +
	"\aremoved\x18\x03 \x01(\bR\aremoved\x12\x16\n" +
	"\x06topics\x18\x04 \x03(\fR\x06topics\"\x98\x01\n" +
	"\x17Eth1InternalTransaction\x12\x12\n" +
	...
	"\x04path\x18\x06 \x01(\tR\x04path\"\xf3\x05\n" +
	"\x10Eth1BlockIndexed\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\x12\x1f\n" +
	"\vparent_hash\x18\x02 \x01(\fR\n" +
	"parentHash\x12\x1d\n" +
	"\n" +
	"uncle_hash\x18\x03 \x01(\fR\tuncleHash\x12\x1a\n" +
	"\bcoinbase\x18\x04 \x01(\fR\bcoinbase\x12\x1e\n" +
	"\n" +
	"difficulty\x18\b \x01(\fR\n" +
	"difficulty\x12\x16\n" +
	"\x06number\x18\t \x01(\x04R\x06number\x12\x1b\n" +
	...
	"\bbase_fee\x18\x12 \x01(\fR\abaseFee\x12\x1f\n" +
	"\vuncle_count\x18\x13 \x01(\x04R\n" +
	"uncleCount\x12+\n" +
	"\x11transaction_count\x18\x14 \x01(\x04R\x10transactionCount\x12\x10\n" +
	"\x03mev\x18\x15 \x01(\fR\x03mev\x12(\n" +
	...
	"\funcle_reward\x18\x1a \x01(\fR\vuncleReward\x12<\n" +
	"\x1ainternal_transaction_count\x18\x1d \x01(\x04R\x18internalTransactionCount\x12\"\n" +
	"\rblob_gas_used\x18\x1e \x01(\x04R\vblobGasUsed\x12&\n" +
	"\x0fexcess_blob_gas\x18\x1f \x01(\x04R\rexcessBlobGas\x124\n" +
	"\x16blob_transaction_count\x18  \x01(\x04R\x14blobTransactionCount\"\x88\x02\n" +
	"\x10Eth1UncleIndexed\x12!\n" +
	"\fblock_number\x18\x01 \x01(\x04R\vblockNumber\x12\x16\n" +
	"\x06number\x18\x02 \x01(\x04R\x06number\x12\x1b\n" +
	"\tgas_limit\x18\x03 \x01(\x04R\bgasLimit\x12\x19\n" +
	"\bgas_used\x18\x04 \x01(\x04R\agasUsed\x12\x19\n" +
	"\bbase_fee\x18\x05 \x01(\fR\abaseFee\x12\x1e\n" +
	"\n" +
	"difficulty\x18\x06 \x01(\fR\n" +
	"difficulty\x12.\n" +
	"\x04time\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x04time\x12\x16\n" +
	"\x06reward\x18\b \x01(\fR\x06reward\"\xdb\x01\n" +
	"\x15Eth1WithdrawalIndexed\x12!\n" +
	...
	"\x04time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x04time\"\xd0\x03\n" +
	"\x16Eth1TransactionIndexed\x12\x12\n" +
	...
	" \x01(\bR\x12isContractCreation\x12\x1b\n" +
	"\terror_msg\x18\f \x01(\tR\berrorMsg\x12\x1e\n" +
	"\vblob_tx_fee\x18\r \x01(\fR\tblobTxFee\x12$\n" +
	"\x0eblob_gas_price\x18\x0e \x01(\fR\fblobGasPrice\x12)\n" +
	"\x06status\x18\x0f \x01(\x0e2\x11.types.StatusTypeR\x06statusJ\x04\b\v\x10\f\"\xfe\x01\n" +
	"\x1eEth1InternalTransactionIndexed\x12\x1f\n" +
	...
	"\x04from\x18\x05 \x01(\fR\x04from\x12\x0e\n" +
	"\x02to\x18\x06 \x01(\fR\x02to\x12\x14\n" +
	"\x05value\x18\a \x01(\fR\x05value\x12\x1a\n" +
	"\breverted\x18\b \x01(\bR\breverted\"\x8e\x03\n" +
	"\x1aEth1BlobTransactionIndexed\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\fR\x04hash\x12!\n" +
	"\fblock_number\x18\x02 \x01(\x04R\vblockNumber\x12.\n" +
	...
	"\x05value\x18\x06 \x01(\fR\x05value\x12\x15\n" +
	"\x06tx_fee\x18\a \x01(\fR\x05txFee\x12\x1b\n" +
	"\tgas_price\x18\b \x01(\fR\bgasPrice\x12\x1e\n" +
	"\vblob_tx_fee\x18\t \x01(\fR\tblobTxFee\x12$\n" +
	"\x0eblob_gas_price\x18\n" +
	" \x01(\fR\fblobGasPrice\x12\x1b\n" +
	"\terror_msg\x18\f \x01(\tR\berrorMsg\x122\n" +
	"\x15blob_versioned_hashes\x18\r \x03(\fR\x13blobVersionedHashesJ\x04\b\v\x10\f\"\xe5\x01\n" +
	"\x10Eth1ERC20Indexed\x12\x1f\n" +
	"\vparent_hash\x18\x01 \x01(\fR\n" +
	"parentHash\x12!\n" +
	"\fblock_number\x18\x02 \x01(\x04R\vblockNumber\x12#\n" +
	...
	"\x04from\x18\x05 \x01(\fR\x04from\x12\x0e\n" +
	"\x02to\x18\x06 \x01(\fR\x02to\x12\x14\n" +
	"\x05value\x18\a \x01(\fR\x05value\"\xeb\x01\n" +
	"\x11Eth1ERC721Indexed\x12\x1f\n" +
	"\vparent_hash\x18\x01 \x01(\fR\n" +
	"parentHash\x12!\n" +
	"\fblock_number\x18\x02 \x01(\x04R\vblockNumber\x12#\n" +
	"\rtoken_address\x18\x03 \x01(\fR\ftokenAddress\x12.\n" +
	...
	"\btoken_id\x18\a \x01(\fR\atokenId\"\x9e\x02\n" +
	"\x12ETh1ERC1155Indexed\x12\x1f\n" +
	"\vparent_hash\x18\x01 \x01(\fR\n" +
	"parentHash\x12!\n" +
	"\fblock_number\x18\x02 \x01(\x04R\vblockNumber\x12#\n" +
	"\rtoken_address\x18\x03 \x01(\fR\ftokenAddress\x12.\n" +
	...
	"\boperator\x18\t \x01(\fR\boperator*2\n" +
	"\n" +
	"StatusType\x12\n" +
	"\n" +
	"\x06FAILED\x10\x00\x12\v\n" +
	"\aSUCCESS\x10\x01\x12\v\n" +
	"\aPARTIAL\x10\x02B\tZ\a./typesb\x06proto3"

var (
	file_eth1_proto_rawDescOnce sync.Once
	file_eth1_proto_rawDescData []byte
)

func file_eth1_proto_rawDescGZIP() []byte {
	file_eth1_proto_rawDescOnce.Do(func() {
		file_eth1_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eth1_proto_rawDesc), len(file_eth1_proto_rawDesc)))
	})
...
var file_eth1_proto_goTypes = []any{
...
func file_eth1_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eth1_proto_rawDesc), len(file_eth1_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   0,
