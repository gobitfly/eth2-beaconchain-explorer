...
func GetValidatorIncomeHistoryChart(validatorIndices []uint64, currency string, lastFinalizedEpoch uint64, days uint64) ([]*types.ChartDataPoint, error) {
	...
	if days == 0 {
		...
		incomeHistory, err = GetValidatorIncomeHistory(validatorIndices, lowerBound, upperBound, lastFinalizedEpoch)
		if err != nil {
			return nil, err
		}
	}
