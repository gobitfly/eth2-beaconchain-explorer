...
},O=k("//","$"),v=k("/\\*","\\*/"),N=k("#","$");var M=Object.freeze({
...
},COMMENT:k,C_LINE_COMMENT_MODE:O,C_BLOCK_COMMENT_MODE:v,HASH_COMMENT_MODE:N,
...
;n+=S.substr(e),M.addText(n)}function d(){null!=v.subLanguage?(()=>{
if(""===S)return;let e=null;if("string"==typeof v.subLanguage){
if(!t[v.subLanguage])return void M.addText(S)
...
value:v}}),v}function f(e,t,n){let r=((e,t)=>{const n=e&&e.exec(t)
...
const t=e[0],i=n.substr(e.index),r=f(v,e,i);if(!r)return q;const s=v
;v.endScope&&v.endScope._wrap?(d(),
M.addKeyword(t,v.endScope._wrap)):v.endScope&&v.endScope._multi?(d(),
u(v.endScope,e)):s.skip?S+=t:(s.returnEnd||s.excludeEnd||(S+=t),
d(),s.excludeEnd&&(S=t));do{
v.scope&&M.closeNode(),v.skip||v.subLanguage||(R+=v.relevance),v=v.parent
}while(v!==r.parent);return r.starts&&h(r.starts,e),s.returnEnd?0:t.length}
...
;throw e.mode=v,e}if("end"===s.type){const e=b(s);if(e!==q)return e}
...
;const _=X(y);let O="",v=s||_;const N={},M=new g.__emitter(g);(()=>{const e=[]
...
;const e=v.matcher.exec(n);if(!e)break;const t=w(n.substring(A,e.index),e)
;A=e.index+t}return w(n.substr(A)),M.closeAllNodes(),M.finalize(),O=M.toHTML(),{
language:e,value:O,relevance:R,illegal:!1,_emitter:M,_top:v}}catch(t){
...
language:e,value:F(n),illegal:!1,relevance:0,errorRaised:t,_emitter:M,_top:v}
...
;return t._emitter.addText(e),t})(e),r=n.filter(k).filter(v).map((t=>E(t,e,!1)))
...
r[e.toLowerCase()]=t}))}function v(e){const t=k(e)
...
listLanguages:()=>Object.keys(t),getLanguage:k,registerAliases:O,
autoDetection:v,inherit:V,addPlugin:e=>{(e=>{
