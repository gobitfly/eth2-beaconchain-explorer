    ...
    Highcharts.chart(containerId, {
      ...
      plotOptions: {
        series: {
          point: {
            events: {
              click: function () { if (this && this.path) { window.location.href = this.path; } }
            }
          }
        },
        treemap: {
      ...
      tooltip: {
        ...
        pointFormatter: function () {
          ...
          return '<span style="font-size:11px">' + name + '</span><br/>' +
            '<span>Net share: <b>' + sharePct + '</b></span><br/>' +
            '<span>Beaconscore: <b>' + effPct + '</b></span>';
        }
      }
    });
  }
