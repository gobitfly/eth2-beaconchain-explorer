...
;(function (a) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/modules/no-data-to-display", ["highcharts"], function (d) {
        a(d)
        a.Highcharts = d
        return a
      })
  ...
  function d(a, c, d, e) {
    a.hasOwnProperty(c) || (a[c] = e.apply(null, d))
  }
  a = a ? a._modules : {}
  d(a, "Extensions/NoDataToDisplay.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function (a, c) {
    var d = c.addEvent,
      e = c.extend,
      f = c.getOptions
    c = a.prototype
    ...
    c.showNoData = function (a) {
      ...
      a = a || (b && b.lang.noData)
      b = b && (b.noData || {})
      this.renderer && (this.noDataLabel || (this.noDataLabel = this.renderer.label(a, 0, 0, void 0, void 0, void 0, b.useHTML, void 0, "no-data").add()), this.styledMode || this.noDataLabel.attr(b.attr).css(b.style || {}), this.noDataLabel.align(e(this.noDataLabel.getBBox(), b.position || {}), !1, "plotBox"))
    }
