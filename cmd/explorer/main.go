...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		apiV1Router.HandleFunc("/validator/{pubkey}", handlers.ApiValidatorByPubkey).Methods("GET")
		...
		apiV1Router.HandleFunc("/validator/eth1/depositpubkey/{pubkey}", handlers.ApiValidatorByEth1DepositPubkey).Methods("GET")
