...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		// router.HandleFunc("/charts/network_liveness", handlers.NetworkLivenessChart).Methods("GET")
		// router.HandleFunc("/charts/participation_rate", handlers.ParticipationRateChart).Methods("GET")
		// router.HandleFunc("/charts/estimated_validator_return", handlers.EstimatedValidatorReturnChart).Methods("GET")
		// router.HandleFunc("/charts/stake_effectiveness", handlers.StakeEffectivenessChart).Methods("GET")
