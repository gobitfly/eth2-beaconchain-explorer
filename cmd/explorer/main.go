...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		apiV1Router.HandleFunc("/slot/{slot}/move-to-compounding_requests", handlers.ApiSlotMoveToCompoundingRequests).Methods("GET", "OPTIONS")
		...
		apiV1Router.HandleFunc("/block/{slot}/move-to-compounding_requests", handlers.ApiSlotMoveToCompoundingRequests).Methods("GET", "OPTIONS")
		...
		apiV1Router.HandleFunc("/validator/{indexOrPubkey}/move-to-compounding_requests", handlers.ApiValidatorMoveToCompoundingRequests).Methods("GET", "OPTIONS")
