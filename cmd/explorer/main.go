...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		if !utils.Config.Frontend.OnlyAPI {
			...
			router.HandleFunc("/validators/streaksleaderboard", handlers.ValidatorsStreaksLeaderboard).Methods("GET")
			router.HandleFunc("/validators/streaksleaderboard/data", handlers.ValidatorsStreaksLeaderboardData).Methods("GET")
