...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		apiV1Router.HandleFunc("/block/{slot}/withdrawals", handlers.ApiBlockWithrdawals).Methods("GET", "OPTIONS")
		...
		if !utils.Config.Frontend.OnlyAPI {
			...
			router.HandleFunc("/slot/{slot}/withdrawals", handlers.ApiBlockWithrdawals).Methods("GET")
