...
func main() {
	...
	if cfg.Frontend.Enabled {
		...
		router.HandleFunc("/dashboard/data/pending", handlers.DashboardValidatorsDataPending).Methods("GET")
		router.HandleFunc("/dashboard/data/active", handlers.DashboardValidatorsDataActive).Methods("GET")
		router.HandleFunc("/dashboard/data/ejected", handlers.DashboardValidatorsDataEjected).Methods("GET")
