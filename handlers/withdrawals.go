...
func Withdrawals(w http.ResponseWriter, r *http.Request) {
	...
	var withdrawalsTemplate = templates.GetTemplate(append(layoutTemplateFiles, []string{"withdrawals.html", "validator/withdrawalOverviewRow.html", "components/charts.html"}...)...)
