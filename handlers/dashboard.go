...
func DashboardDataValidators(w http.ResponseWriter, r *http.Request) {
	...
	for i, v := range validators {
		...
		tableData[i] = append(tableData[i], template.HTML(fmt.Sprintf(`<button class="btn btn-sm" onclick="removeValidator('%v')"><i class="fas fa-times-circle"></i></button>`, v.ValidatorIndex)))
	}
