...
func Broadcast(w http.ResponseWriter, r *http.Request) {
	var tpl = templates.GetTemplate(append(layoutTemplateFiles, []string{"components/bannerGeneric.html", "broadcast.html", "validator/withdrawalOverviewRow.html"}...)...)
...
func BroadcastStatus(w http.ResponseWriter, r *http.Request) {
	var tpl = templates.GetTemplate(append(layoutTemplateFiles, []string{"components/bannerGeneric.html", "broadcaststatus.html"}...)...)
	w.Header().Set("Content-Type", "text/html")
