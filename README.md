...
- Open a new terminal in project directory and run `docker run -it --rm --net=host -v ${dir}/:/src  postgres psql -f /src/tables.sql -d db -h 0.0.0.0 -U postgres` to create new tables in the database  
